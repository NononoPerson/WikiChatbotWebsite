...
def home():
    ...
    elif "what are the school timings for pre-primary students" in question:
        answer = "Typically 8:30 am to 12:30 pm (verify from the school office)."
    elif "what are the school timings for primary and secondary students" in question:
        answer = "Generally 8:30 am to 3:30 pm."
    elif "does the school provide transport facilities" in question:
        answer = "Yes."
    elif "does pallavi international school gandipet have smart classes" in question:
        answer = "Yes."
